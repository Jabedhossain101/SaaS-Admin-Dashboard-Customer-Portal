import { Database, Clock, Sparkles, Inbox, ShieldCheck } from 'lucide-react';
...
export const metadata = {
  ...
  description: 'Global system audit logs, security events, and tenant telemetry.',
};
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Badge variant="purple" className="self-start sm:self-auto text-xs py-1 font-semibold">
        ...
        <CardContent className="p-0">
          {logs.length > 0 ? (
                ...
                return (
                  ...
                  >
                    <div className="flex items-start sm:items-center gap-3.5 min-w-0">
                      <div className="p-2.5 rounded-xl bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-100 dark:border-indigo-500/20 text-indigo-600 dark:text-indigo-400 shrink-0">
            ...
            <div className="py-16 text-center text-slate-500 dark:text-slate-400">
              <Inbox className="w-8 h-8 mx-auto text-slate-400 dark:text-slate-500 mb-2" />
